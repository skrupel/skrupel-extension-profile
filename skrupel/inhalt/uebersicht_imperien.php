                                            ...
                                            for ($k=1;$k<11;$k++) {
                                                if ($spieler_id_c[$k]>=1) {
                                                    ...
                                                    ?>
                                                        ...
                                                        <td>&nbsp;</td>
                                                        <td style="color:<?php echo $spielerfarbe[$k]?>;font-size:12px;" width="100%"><?php echo $spieler_rassename_c[$k]?><?php if ($spieler==$k) {?> <a href="uebersicht_imperien.php?fu=2&spid=<?php echo $spieler?>&uid=<?php echo $uid?>&sid=<?php echo $sid?>" style="font-size:9px;">(<?php echo $lang['uebersichtimperien']['edit']?>)</a><?php }?><br><br><nobr><a href="uebersicht_imperien.php?fu=4&spid=<?php echo $user_id?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid?>"><?php echo $username?></a></nobr></td>
